...
This is yet *another* version of the solutions to [Advanced R, 2nd edition](https://adv-r.hadley.nz/) (`advR2`). I've returned to `advR2` more than any other for my day-to-day activities as an R developer. After working through each of the exercises, then reading how others had solved them, I decided some the approaches I took to solving the exercises differed enough to warrant putting them into a book. 
